...
\paragraph{}
Если точка лежит внутри треугольника, то треугольники не будут пересекаться и сумма $k_1+k_2+k_3$ будет равна 1.

\paragraph{}
Площадь треугольника вычисляется как проекция векторного произведения двух рёбер треугольника на его нормаль.
Например, для треугольника $ABC$ площадь будет $S_{ABC} = \langle n, (B-A) \times (C-A) \rangle$.
...
По определению нужна точка с наибольшей $\lambda$. Можно её нарисовать:
...
вектору из начала координат в точку $b$. На эти плоскости этих граней точку $b$ спроецировать впринципе нельзя. 
